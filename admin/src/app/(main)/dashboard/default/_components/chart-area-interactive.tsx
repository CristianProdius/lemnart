...
export function ChartAreaInteractive({ data }: { data?: RevenueDataPoint[] }) {
    ...
    return (
      <Card className="@container/card">
        <CardHeader>
          ...
          <CardDescription>
            <span className="@[540px]/card:block hidden">Revenue from paid orders</span>
            <span className="@[540px]/card:hidden">Paid orders</span>
          </CardDescription>
          <CardAction>
            <ToggleGroup
              type="single"
        ...
        <CardContent className="px-2 pt-4 sm:px-6 sm:pt-6">
          <ChartContainer config={revenueChartConfig} className="aspect-auto h-62 w-full">
  ...
  const filteredData = defaultChartData.filter((item) => {
    const date = new Date(item.date);
  ...
  return (
    <Card className="@container/card">
      ...
      <CardContent className="px-2 pt-4 sm:px-6 sm:pt-6">
        <ChartContainer config={defaultChartConfig} className="aspect-auto h-62 w-full">
          <AreaChart data={filteredData}>
            <defs>
